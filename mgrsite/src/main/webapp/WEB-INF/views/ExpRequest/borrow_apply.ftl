...
<html>
						...
						form.ajaxSubmit(function (data) {
							if(data.success){
							    $.messager.confirm("提示","提交成功",function () {
									window.location.href="/borrowApply.do"
                                })
							}
                        })
                    }
	...
	<body>
		<!-- 网页顶部导航 -->
		<#include "../common2/head-tpl.ftl" />
		<#assign currentNav="borrow" />
		<!-- 网页导航 -->
		<#include "../common2/navbar-tpl.ftl" />
		...
		<div class="container">
			...
			<div class="page-header lead">
				借款信息
				<label class="label label-primary">体验标</label>
			</div>
		...
		<#include "../common2/footer-tpl.ftl" />
	</body>
</html>
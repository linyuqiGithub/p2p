				...
				<div class="el-borrow-item-content">
					...
					<ul>
						<li>
							...
							<#else>
								已填写基本资料<span class="glyphicon glyphicon-ok" style="color:green;"></span>
							</#if>
						</li>
						<li>
							<#if !(userinfo.isRealAuth)>
								...
								<span class="glyphicon glyphicon-remove" style="color:red;"></span>
							<#else>
								已完成身份认证<span class="glyphicon glyphicon-ok" style="color:green;"></span>
							</#if>
						</li>
						<li>

            ...
            $("#editForm").validate({
                rules: {
                    bidRequestAmount: {
                        required: true,
                        number: true,
                        min: ${minBidRequestAmount},//最小借款金额
                        max: ${account.remainBorrowLimit?string("##.##")}//剩余信用额度(最大借款金额)
                    },
                    currentRate: {
                        required: true,
                        number: true,
                        min: ${minCurrentRate},//最小借款利息
                        max: ${maxCurrentRate}//最大借款利息
                    },
                    minBidAmount: {
                        required: true,
                        number: true,
                        min: ${minBidAmount}//最小投标金额
                    },
                    title: "required"
                },
                messages: {
